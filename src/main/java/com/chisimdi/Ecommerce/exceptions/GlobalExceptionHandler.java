...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> invalidCredentialsHandler(InvalidCredentialsException e) {
    ...
    public ResponseEntity<ApiError> conflictHandler(ConflictException e) {
